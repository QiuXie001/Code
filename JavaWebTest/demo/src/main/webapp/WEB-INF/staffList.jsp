...
<p>当前系统在线人数：<%= application.getAttribute("onlineUserCount") %>人</p>
  ...
  <% 
          ...
          else
          {
           ...
           out.println("<td><a href=\"/demo/WorkManage/update?id="+student.getStuCode()+"\">修改</a> <a href=\"/demo/WorkManage/delete?id="+student.getStuCode()+"\" onclick=\"return confirm('确定删除该学生吗')\">删除</a></td></tr>");
 		     }    
         out.println("<tr><td colspan=\"6\" align=\"center\"><a href=\"/demo/WorkManage/add\">添加员工</a> </td></tr>");     
