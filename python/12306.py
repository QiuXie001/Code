...
if __name__ == '__main__':
    ...
    city_list = {
        ...
        'yc':'%u76D0%u57CE%2CAFH',#盐城
        'cc':'%u957F%u6625%2CCCT',#长春
    }
    # 出发站
    ...
    # 抢票成功，通知该手机号码
    receiver_mobile = '18151939379' #input('请预留一个手机号码，方便抢到票后进行通知（例如：18888888888）：')
    ...
    receiver_email = '1357947563@qq.com'#input('请预留一个邮箱，方便抢到票后进行通知（例如：test@163.com）：')
